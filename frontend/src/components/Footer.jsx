              ...
              {[
                ...
                <li key={idx}>
                  <Link to={link.path} className="hover:text-red-500 transition-colors flex items-center gap-2 group">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-3 h-3 text-slate-600 group-hover:text-red-500">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>123 Medical Road, Dhaka, Bangladesh</span>
              </li>
